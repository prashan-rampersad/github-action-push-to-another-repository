...
ABSOLUTE_TARGET_DIRECTORY="$CLONE_DIR/REPOSITORIES/$SOURCE_REPOSITORY_NAME/$TARGET_DIRECTORY/"
...
cp -ra "$SOURCE_DIRECTORY"/. "$CLONE_DIR/REPOSITORIES/$SOURCE_REPOSITORY_NAME/$TARGET_DIRECTORY"
cd "$CLONE_DIR"
